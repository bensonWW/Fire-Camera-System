...
#define configUSE_NEWLIB_REENTRANT              1  // Enable task-safe newlib support when using printf from FreeRTOS tasks
...
#define configENABLE_TRUSTZONE                  0  // 選用 Non-TrustZone 移植層，強制設為 0

// ====================================================================================
// == 2. 多核心調度設定（修正為單核心模式運作） ==
...
#define configKERNEL_INTERRUPT_PRIORITY          ( 7 << 5 ) /* 最低優先權 7 */
#define configMAX_SYSCALL_INTERRUPT_PRIORITY     ( 5 << 5 ) /* 高於此優先權的中斷不受 RTOS 影響 */
